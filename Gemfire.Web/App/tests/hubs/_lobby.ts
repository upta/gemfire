...
{
    sinon.stub( require( "durandal/app" ), "trigger", function ( events: string )
    {
...
{
    sinon.stub( $.connection.lobby.server, "createGame", function ( events: string )
    {
        ok( true );
    } );
...
{
    sinon.stub( $.connection.lobby.server, "joinGame", function ( events: string )
    {
        ok( true );
    } );
...
{
    sinon.stub( $.connection.lobby.server, "leaveGame", function ( events: string )
    {
        ok( true );
    } );
...
{
    sinon.stub( $.connection.lobby.server, "getGames", function ( events: string )
    {
        ok( true );
    } );
